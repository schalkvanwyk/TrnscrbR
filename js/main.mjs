...
listenFor('change', '#mediaFileSource', handleMediaFileSelect);
listenFor('change', '#transcriptFileSource', handleJsonFileSelect);

const mediaPlayer = $id('mediaPlayer');
// mediaPlayer.muted = true;
mediaPlayer.addEventListener('timeupdate', handleMediaTimeUpdated, false);
// listenFor('timeupdate', '#mediaPlayer', handleMediaTimeUpdated);
mediaPlayer.addEventListener('play', handleMediaPlay, false);
// listenFor('play', '#mediaPlayer', handleMediaPlay);
mediaPlayer.addEventListener('ended', handleMediaEnded, false);
// listenFor('ended', '#mediaPlayer', handleMediaEnded);
mediaPlayer.addEventListener('seeked', handleMediaSeeked, false);
...
// listenFor('speaking', transcriptWrapper, handleSpeaking);
